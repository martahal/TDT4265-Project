...
class ResNetBackbone(torch.nn.Module):
    ...
    def __init__(self, cfg):
        super().__init__()
        self.model = resnet18(pretrained=cfg.MODEL.BACKBONE.PRETRAINED)
        output_channels = cfg.MODEL.BACKBONE.OUT_CHANNELS
        self.output_channels = output_channels
        image_channels = cfg.MODEL.BACKBONE.INPUT_CHANNELS
        self.image_channels = image_channels
        self.output_feature_extractor = cfg.MODEL.PRIORS.FEATURE_MAPS
        self.feature_extractor = nn.Sequential(OrderedDict([
            ('layer1', nn.Sequential(self.model.layer1, self.model.layer2, self.model.layer3)),
            ('layer2', self.model.layer4),
